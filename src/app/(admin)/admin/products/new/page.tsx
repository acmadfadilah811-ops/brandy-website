...
export default function NewProductPage() {
  ...
  const [category, setCategory] = useState<any>("Collaboration");
  const [badge, setBadge] = useState("");
  const [color, setColor] = useState("text-blue-600 bg-blue-50 border-blue-200");
  
  // ROI fields
  const [roiTitle, setRoiTitle] = useState("");
  const [roiDesc, setRoiDesc] = useState("");
  const [roiMetric, setRoiMetric] = useState("");
  ...
  const updateFeature = (index: number, field: keyof FeatureInput, value: string) => {
    const next = [...features];
    ...
    <div className="space-y-6 max-w-5xl">
      <div className="space-y-2">
        ...
        <p className="text-xs text-slate-500">
          Publikasikan produk baru ke website Brandy. Rincian ROI, spesifikasi, dan video demo didukung penuh.
        </p>
      </div>
          ...
          <div className="bg-white border border-slate-200 rounded-xl p-6 shadow-sm space-y-5">
            ...
            <div>
              ...
              <input
                ...
                placeholder="cth: Brandy Workspace"
              />
            ...
            <div>
              ...
              <input
                ...
                placeholder="cth: Kolaborasi tim modern dalam satu ruang kerja digital terpadu."
              />
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="Tuliskan deskripsi lengkap mengenai tujuan produk, kegunaan utama, serta manfaatnya bagi operasional tim..."
              />
          ...
          <div className="bg-white border border-slate-200 rounded-xl p-6 shadow-sm space-y-5">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  placeholder="cth: 35%, 15x, Rp 50Jt"
                />
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="cth: Peningkatan Produktivitas Terukur"
                />
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="Tulis penjelasan dampak ROI yang diperoleh klien secara mendalam..."
              />
                ...
                <div key={index} className="p-4 border border-slate-100 rounded-lg bg-slate-50/50 space-y-3 relative">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        placeholder="Zap, Shield, Globe, Users"
                      />
                    </div>
                    <div className="md:col-span-2">
                      ...
                      <input
                        ...
                        className="w-full border border-slate-200 rounded px-2.5 py-1.5 text-xs focus:outline-none focus:border-brand-blue-mid"
                        placeholder="cth: Real-time Collaboration"
                      />
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full border border-slate-200 rounded px-2.5 py-1.5 text-xs focus:outline-none focus:border-brand-blue-mid"
                      placeholder="Tulis penjelasan cara kerja fitur ini..."
                    />
                  </div>
                </div>
              ))}
          ...
          <div className="bg-white border border-slate-200 rounded-xl p-6 shadow-sm space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className="w-full border border-slate-200 rounded-lg px-3 py-2 text-xs focus:outline-none focus:border-brand-blue-mid transition-all"
                placeholder="cth: Package, Users, Briefcase"
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                className="w-full border border-slate-200 rounded-lg px-3 py-2 text-xs focus:outline-none focus:border-brand-blue-mid transition-all"
                placeholder="cth: Populer, Terlaris, AI"
              />
            </div>
          </div>
          ...
          <div className="bg-white border border-slate-200 rounded-xl p-6 shadow-sm space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className="w-full border border-slate-200 rounded-lg px-3 py-2 text-xs focus:outline-none focus:border-brand-blue-mid transition-all"
                placeholder="cth: Slack, Google Drive, WhatsApp"
              />
            </div>
